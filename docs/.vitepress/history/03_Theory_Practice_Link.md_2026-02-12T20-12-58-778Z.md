# PPO：从公式到代码的实现指南 [​](#ppo-从公式到代码的实现指南)

本文档详细解释如何将PPO理论公式转化为Python代码，

## 1. 核心公式与代码对应 [​](#_1-核心公式与代码对应)

### 1.1 概率比 $r_t(\theta)$ [​](#_1-1-概率比)
...
### 1.2 PPO-Clip目标 [​](#_1-2-ppo-clip目标)
...
## 2. Actor-Critic架构 [​](#_2-actor-critic架构)

### 2.1 为什么共享底层网络？ [​](#_2-1-为什么共享底层网络)
...
## 5. LLM-PPO特殊考虑 [​](#_5-llm-ppo特殊考虑)

### 5.1 Token-level vs Response-level [​](#_5-1-token-level-vs-response-level)
...
### 5.3 Value Head [​](#_5-3-value-head)
