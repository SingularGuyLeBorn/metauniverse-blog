# 强化学习的数学原理：从贝尔曼方程到 GRPO [​](#强化学习的数学原理-从贝尔曼方程到-grpo) [​](#强化学习的数学原理-从贝尔曼方程到-grpo-​) [​](#强化学习的数学原理-从贝尔曼方程到-grpo-​-​) [​](#强化学习的数学原理-从贝尔曼方程到-grpo-​-​-​)
...
## 第一部分：基石 (Foundations) [​](#第一部分-基石-foundations) [​](#第一部分-基石-foundations-​) [​](#第一部分-基石-foundations-​-​) [​](#第一部分-基石-foundations-​-​-​)
...
/
## 第二部分：策略梯度进阶 (Advanced Policy Gradients) [​](#第二部分-策略梯度进阶-advanced-policy-gradients) [​](#第二部分-策略梯度进阶-advanced-policy-gradients-​) [​](#第二部分-策略梯度进阶-advanced-policy-gradients-​-​) [​](#第二部分-策略梯度进阶-advanced-policy-gradients-​-​-​)
...
## 第三部分：人类偏好对齐 (Preference Optimization) [​](#第三部分-人类偏好对齐-preference-optimization) [​](#第三部分-人类偏好对齐-preference-optimization-​) [​](#第三部分-人类偏好对齐-preference-optimization-​-​) [​](#第三部分-人类偏好对齐-preference-optimization-​-​-​)

大语言模型时代的核心技术，如何让模型符合人类价值观。

### 核心算法 [​](#核心算法) [​](#核心算法-​) [​](#核心算法-​-​) [​](#核心算法-​-​-​)
...
## 第四部分：前沿探索 (Frontiers) [​](#第四部分-前沿探索-frontiers) [​](#第四部分-前沿探索-frontiers-​) [​](#第四部分-前沿探索-frontiers-​-​) [​](#第四部分-前沿探索-frontiers-​-​-​)
