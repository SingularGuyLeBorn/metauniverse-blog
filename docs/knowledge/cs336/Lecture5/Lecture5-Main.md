...
![矩阵乘法性能图](images/l5-matmul-performance.png)
...
![语言模型的缩放法则](images/l5-scaling-laws.png)
...
![处理器42年发展数据](images/l5-processor-trend.png)
...
![单芯片推理性能在10年内提升1000倍](images/l5-inference-performance.png)
...
![CPU与GPU的架构对比](images/l5-cpu-vs-gpu-arch.png)
...
![GA100 GPU的完整架构图](images/l5-ga100-arch.png)
...
![NVIDIA A100 GPU的芯片布局和内存延迟](images/l5-a100-layout-latency.png)
...
![GPU执行模型示意图](images/l5-gpu-execution-model.png)
...
![GPU内存模型示意图](images/l5-gpu-memory-model.png)
...
![l5-memory-hierarchy.png](images/l5-memory-hierarchy.png)
...
![Google的TPU模型](images/l5-tpu-model.png)
...
![计算能力和内存的差距在逐渐拉大](images/l5-compute-memory-gap.png)
...
![屋顶线模型 (Roofline Model)](images/l5-roofline-model.png)
...
![控制流分歧的执行示意图](images/l5-control-flow-divergence.png)
...
![混合精度计算在Tensor Core中的实现](images/l5-tensor-core-mixed-precision.png)
...
举个例子
![混合精度训练示意图](images/l5-mixed-precision-training.png)
...
![l5-memory-bound-ops.png](images/l5-memory-bound-ops.png)
...
这个融合后的内核会:
![l5-arithmetic-intensity.png](images/l5-arithmetic-intensity.png)
...
![前向传播和反向传播示意图](images/l5-fwd-bwd-pass.png)
...
![重计算前后的内存访问对比.png](images/l5-recomputation-memory.png)  ![l5-recomputation-graph.png](images/l5-recomputation-graph.png)
...
![l5-gradient-checkpointing.png](images/l5-gradient-checkpointing.png)
...
![l5-operator-fusion.png](images/l5-operator-fusion.png)
...
![l5-kernel-launch-overhead.png](images/l5-kernel-launch-overhead.png)
...
![l5-tiling-memory-access.png](images/l5-tiling-memory-access.png)
...
![矩阵乘法性能图](images/l5-matmul-perf-tiled.png)

> 图22: 再看这张图, 我们现在可以识别出一些模式, 如计算强度和可能的平铺效应.

这张图展示了不同矩阵维度下的性能. 我们可以用我们学到的知识来解释它.
![平铺对性能的影响](images/l5-tiling-impact.png)
...
![波浪量化效应](images/l5-quantization-wave.png)
...
![标准注意力和FlashAttention的性能对比](images/l5-flash-vs-std-attn.png)
...
![FlashAttention中的平铺操作](images/l5-flash-attn-tiling.png)
...
![标准Softmax与在线Softmax](images/l5-online-softmax.png)
...
### 课程总结
![l5-flash-attn-impl.png](images/l5-flash-attn-impl.png)
